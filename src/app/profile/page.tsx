...
const ProfilePage: React.FC = () => {
  const [profile, setProfile] = useState({
    username: "TheHive",
    fullName: "Bee Farmer",
    bio: "Product/service\nEverything Honey Flavored",
    profilePic: "/avatarpic.png",
    websiteUrl: "farmerhoney.com",
    posts: 5,
    followers: 69,
    following: 143,
    isFollowing: false,
    ...
    <div >
        ...
        <section className={styles.profileInfo}>
          <div className={styles.usernameRow}>
            ...
            <div className={styles.actionButtons}>
              <button
                className={profile.isFollowing ? styles.secondaryButton : styles.primaryButton}
          ...
          <div className={styles.statsContainer}>
            <div className={styles.statItem}>
              <span className={styles.statCount}>{profile.posts}</span>
              <span className="ml-1">posts</span>
            </div>
            <div className={styles.statItem}>
              <span className={styles.statCount}>{profile.followers}</span>
              <span className="ml-1">followers</span>
            </div>
            <div className={styles.statItem}>
              <span className={styles.statCount}>{profile.following}</span>
          ...
          <div className={styles.bioSection}>
            ...
            <a href={`https://${profile.websiteUrl}`} className="text-blue-900 font-medium">
              {profile.websiteUrl}
            </a>
          </div>
        </section>
      ...
      <div className={styles.highlightsSection}>
        ...
        <div className={styles.highlightItem}>
          ...
          <span className={styles.highlightLabel}>Members</span>
        </div>
        <div className={styles.highlightItem}>
          <div className={styles.highlightCircle}>
            <div className={styles.highlightInner}>
          ...
          <span className={styles.highlightLabel}>Events</span>
        </div>
      </div>
      ...
      <div className={styles.tabsContainer}>
        <div className={styles.tabs}>
          ...
          >
            <svg aria-label="Posts" fill="currentColor" height="12" role="img" viewBox="0 0 24 24" width="12" className="mr-1.5">
          ...
          >
            <svg aria-label="Saved" fill="currentColor" height="12" role="img" viewBox="0 0 24 24" width="12" className="mr-1.5">
              <path d="M20 22a.999.999 0 0 1-.687-.273L12 14.815l-7.313 6.912A1 1 0 0 1 3 21V3a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1z" fill="none" stroke="currentColor" strokeWidth="2"></path>
            </svg>
            <span>Saved</span>
          </button>
          <button 
          ...
          >
            <svg aria-label="Tagged" fill="currentColor" height="12" role="img" viewBox="0 0 24 24" width="12" className="mr-1.5">
          ...
          <div key={post.id} className={styles.postItem}>
            ...
            <div className={styles.postOverlay}>
              <div className={styles.postStat}>
                <svg aria-label="Like" fill="#ffffff" height="18" role="img" viewBox="0 0 24 24" width="18" className="mr-1">
              ...
              <div className={styles.postStat}>
                <svg aria-label="Comment" fill="#ffffff" height="18" role="img" viewBox="0 0 24 24" width="18" className="mr-1">
